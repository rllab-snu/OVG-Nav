...
from model_pano_free import Model_pano_free as Model
...
from dataloader_pano_free_0226 import RGB_pano_dataLoader_free as RGB_dataLoader
...
parser.add_argument('--max-epoch', type=int, default=30, help="maximum epoch for training (default: 60)")
...
parser.add_argument('--data-dir', default='Dataset/habitat_obj_relation/mp3d_panoonly_free_0224_random_sample', type=str)
parser.add_argument('--log_dir', default='logs/0227/lr{}_0227_range_{}_no_resize', type=str)
