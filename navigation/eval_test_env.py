...
parser.add_argument("--save_dir", type=str, default="/disk1/hwing/Dataset/cm_graph/test/hwiyeon_home")
parser.add_argument("--seed", type=int, default=1)
parser.add_argument("--scene", type=str, default="/home/hwing/Dataset/habitat/data/scene_datasets/hwiyeon_home")
...
import eval_runner_test_env as runner
