...
parser.add_argument("--use_in_data_split", type=bool, default=True)
...
# parser.add_argument("--save_dir", type=str, default="/disk1/hwing/Dataset/cm_graph/{}/{}/test/test3_3")
parser.add_argument("--save_dir", type=str, default="/disk1/hwing/Dataset/cm_graph/{}/{}/cpu_invalid_node_v2_11-01_mp3d21_edge1v1.012_panov8_layer10_hidden512_epochv0_6_goalscore_w_adjmtx_valueloss1.0_adjloss100.0_adjsimlos0.0_signloss0.0_use_cm_comet_maxdist30.0_lr0.001")
...
parser.add_argument("--value_model", type=str, default='/home/hwing/Projects/OVG-Nav/goal_dist_pred/models/11-01_mp3d21_edge1v1.012_panov8_layer10_hidden512_epochv0_6_goalscore_w_adjmtx_valueloss1.0_adjloss100.0_adjsimlos0.0_signloss0.0_use_cm_comet_maxdist30.0_lr0.001/model.pth')
